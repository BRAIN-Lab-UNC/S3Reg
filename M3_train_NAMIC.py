...
writer = SummaryWriter('log/NAMIC')
...
#    moving_warp_phi_3d = fixed_xyz + phi_3d
#    moving_warp_phi_3d = moving_warp_phi_3d/(torch.norm(moving_warp_phi_3d, dim=1, keepdim=True).repeat(1,3))
        
#    phi_3d = 1.0/torch.sum(fixed_xyz_0 * moving_warp_phi_3d, 1).unsqueeze(1) * moving_warp_phi_3d - fixed_xyz_0
#    moving_warp_phi_3d = fixed_xyz + phi_3d
#    moving_warp_phi_3d = moving_warp_phi_3d/(torch.norm(moving_warp_phi_3d, dim=1, keepdim=True).repeat(1,3))
...
#    loss_l1 = torch.mean(torch.abs(fixed_inter - moving_sulc))
