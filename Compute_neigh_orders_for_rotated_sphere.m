...
sphere_163842 = mvtk_read('/media/fenqiang/DATA/unc/Data/Template/sphere_163842_rotated_2.vtk');
...
save('/media/fenqiang/DATA/unc/Data/registration/scripts/neigh_indices/adj_mat_order_163842_rotated_2.mat', 'adj_mat_order'); 
...
save('/media/fenqiang/DATA/unc/Data/registration/scripts/neigh_indices/adj_mat_order_40962_rotated_2.mat', 'adj_mat_order'); 
...
for n = 1:length(nums)
    ...
    save(strcat('/media/fenqiang/DATA/unc/Data/registration/scripts/neigh_indices/adj_mat_order_', num2str(num), '_rotated_2.mat'), 'adj_mat_order'); 
